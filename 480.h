...
public:
    ...
    void remove(int data)
    {
        ...
        {
            smallSize--;
            if (data == smallHeap.top()) prune(smallHeap);
        }
        else
        {
            largeSize--;
            if (data == largeHeap.top()) prune(largeHeap);
    ...
    double getMedium() {return k % 2 != 0 ? smallHeap.top() : (double)(smallHeap.top() + largeHeap.top()) / 2;}
